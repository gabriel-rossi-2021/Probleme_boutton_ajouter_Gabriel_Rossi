        ...
        try:
            ...
            with MaBaseDeDonnee().connexion_bd.cursor() as mc_afficher:
                if order_by == "ASC" and id_collaborateur_sel == 0:
                    ...
                    strsql_collaborateur_afficher = """SELECT id_collaborateur, nom_famille, prenom FROM t_collaborateur ORDER BY id_collaborateur ASC = %(value_id_collaborateur_selected)s"""
    ...
    if request.method == "POST":
        try:
            ...
            if form.validate_on_submit():
                name_genre_wtf = form.nom_famille_wtf.data
